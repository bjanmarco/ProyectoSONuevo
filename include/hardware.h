...
// con un int normal seria un problema manejar el formato decimal de 8 digitos que se pidio
typedef struct {
    int signo;      // 0 es +, 1 es - 
...
typedef struct {
    ...
    int modoOperacion;          // Usuario (0) y Kernel (1). 
...
typedef struct {
    ...
    RegistroIr ir;  
    int rb;         // donde empieza el programa.
    int rl;         // limite del programa, si nos pasamos violamos el segmento
    int rx;         // Base de pila
...
// resultados de comparaciones para el codigo de condicion
#define CC_CERO                 0       
...
#define OP_SVC                  13      // el usuario pide ayuda al SO, un system call
#define OP_RETRN                14      
#define OP_HAB                  15      
#define OP_DHAB                 16      
#define OP_TTI                  17      
...
// el CPU configura estos registros y luego dispara el DMA (Solo kernel)
#define OP_SDMAP                28      
#define OP_SDMAC                29      
#define OP_SDMAS                30      
#define OP_SDMAIO               31      
...
#define TAMANO_SECTOR           9       // cabe justo una Palabra o char string
