...
int manejarInterrupcion(int codigoInterrupcion) {
    ...
    if (codigoInterrupcion == INT_SVC) {
        logCpu("Ejecucion terminada por SVC (Fase 1 no tiene SO para continuar)");
        return 0; // Termina la simulacion de esta ejecucion
    } else if (!esRecuperable) {
